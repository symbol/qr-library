...
```ts
// examples/GenerateQRCodeForTransaction.ts
...
```ts
// examples/GenerateQRCodeForCustomObject.ts
...
```ts
// examples/GenerateContactQRCode.ts
...
```ts
// examples/GenerateQRCodeForMnemonic.ts
